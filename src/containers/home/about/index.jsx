                        ...
                        <div className="col-xl-5 col-lg-6 mb-7">
                            <div className="about-content">
                                ...
                                <p className="mb-5">
                                    ...
                                    brainchild of visionaries Tejan Suvarna,
                                    Kaushik Patil and Cary Wood. Fueled by a
                                    collective passion for innovation, we bring
                                    a wealth of experience in social media
                                    marketing, web development, and creative
                                    design. At Unscrap, we are dedicated to
                                    reshaping the digital landscape by
                                    seamlessly integrating technology and
                                    creativity, delivering cutting-edge
                                    solutions that empower businesses to thrive
                                    in the ever-evolving online world.
                                </p>
